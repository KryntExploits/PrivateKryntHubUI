if (game:GetService("CoreGui")):FindFirstChild("KryntHub") and (game:GetService("CoreGui")):FindFirstChild("ScreenGui") then
	(game:GetService("CoreGui")).KryntHub:Destroy();
	(game:GetService("CoreGui")).ScreenGui:Destroy();
end;
_G.Primary = Color3.fromRGB(50, 255, 100)
_G.Dark    = Color3.fromRGB(15, 15, 20)
_G.Third   = Color3.fromRGB(0, 150, 50)
...
ImageButton.Image = "rbxassetid://85288478640954";
ImageButton.AutoButtonColor = false;
MakeDraggable(ImageButton, OutlineButton);
CreateRounded(ImageButton, 10);
ImageButton.MouseButton1Click:connect(function()
	(game.CoreGui:FindFirstChild("KryntHub")).Enabled = not (game.CoreGui:FindFirstChild("KryntHub")).Enabled;
end);
...
function Update:Notify(desc)
	...
	Image.Image = "rbxassetid://85288478640954";
	Title.Parent = Frame;
...
(getgenv()).LoadConfig = function()
	if readfile and writefile and isfile and isfolder then
		if not isfolder("KryntHub") then
			makefolder("KryntHub");
		end;
		if not isfolder("KryntHub/Library/") then
			makefolder("KryntHub/Library/");
		end;
		if not isfile(("KryntHub/Library/" .. game.Players.LocalPlayer.Name .. ".json")) then
			writefile("KryntHub/Library/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(SettingsLib));
		else
			local Decode = (game:GetService("HttpService")):JSONDecode(readfile("KryntHub/Library/" .. game.Players.LocalPlayer.Name .. ".json"));
...
(getgenv()).SaveConfig = function()
	if readfile and writefile and isfile and isfolder then
		if not isfile(("KryntHub/Library/" .. game.Players.LocalPlayer.Name .. ".json")) then
			...
			writefile("KryntHub/Library/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(Array));
		end;
	else
		return warn("Status : Undetected Executor");
	end;
...
function Update:Window(Config)
	...
	local KryntHub = Instance.new("ScreenGui");
	KryntHub.Name = "KryntHub";
	KryntHub.Parent = game.CoreGui;
	KryntHub.DisplayOrder = 999;
	local OutlineMain = Instance.new("Frame");
	OutlineMain.Name = "OutlineMain";
	OutlineMain.Parent = KryntHub;
